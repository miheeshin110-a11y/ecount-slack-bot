...
**중요: 검색어(query, prodQuery, custQuery)는 사용자가 말한 단어를 절대 줄이거나 일부만 빼지 마라.** "알파CD"라고 했으면 "알파"가 아니라 반드시 "알파CD" 그대로 추출한다. "그레인버닝"이라고 했으면 "그레인"이 아니라 "그레인버닝" 그대로. 일부만 추출하면 관련없는 다른 품목까지 검색되어 혼란을 준다.
